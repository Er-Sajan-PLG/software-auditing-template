...
/**
 * Self-extension: USA auditing stacks it ships no pack for.
 *
...
const REVIEW_HEADER = `# =============================================================================
# GENERATED by \`usa bootstrap\` — REVIEW REQUIRED before use.
...
function renderFallbackPack(lang: string): BootstrapPack {
  ...
  const doc = {
    ...
    section: 'S15',
    section_title: 'Platform-Specific',
    description: `Fallback prompts for ${lang} — USA has no curated checks for this language yet. Human review carries this pack. (bootstrap v0.1 — unreviewed)`,
    version: '0.1.0-bootstrap',
