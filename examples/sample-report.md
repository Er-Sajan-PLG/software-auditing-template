...
> Generated by **USAT** · schema `usat-report-v1`
...
<sub>Report generated by USAT — the Universal Software Audit Template. Scores are reproducible: re-run with the same rules and depth to compare. USAT checks process and code hygiene; it is not a penetration test.</sub>
